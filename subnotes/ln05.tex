...
\begin{ln-define}{Directed-ness of Edge}{}
    If an edge models a one-way path from one vertex to another, such an edge is known as a \textbf{directed edge}. Mathematically, it is represented as an edge with an arrowmark. For the edge set from the above example,
